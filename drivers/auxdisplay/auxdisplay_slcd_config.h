...
struct auxdisplay_panel_config {
	...
	const uint8_t *indicator_masks;      /* Optional. NULL if DT property absent */
...
#define SLCD_SINGLE_DOT_MASK         0x01
#define SLCD_DOUBLE_DOT_MASK         0x02
#define SLCD_TRIPLE_DOT_MASK         0x04
#define SLCD_4_BIT_BARS_MASK         0x08
#define SLCD_ROTATED_SINGLE_DOT_MASK 0x10
...
#define SLCD_PANEL_CONFIG(n)                                                                       \
	...
	SLCD_PANEL_OPTIONAL_ARRAY(n, indicator_masks)                                              \
	...
	static const struct auxdisplay_panel_config slcd_panel_config_##n = {                      \
		...
		.indicator_masks = SLCD_PANEL_OPTIONAL_REF(n, indicator_masks),                    \
